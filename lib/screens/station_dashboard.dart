          ...
          children: [
            ...
            if (!isVerified)
              const Expanded(
                child: Center(
                  child: Text(
                    "🚫 Your station is NOT verified yet.\nContact admin to gain access.",
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        ElevatedButton.icon(
                          ...
                          label: const Text("Inter-station chat"),
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                    ...
                    TextField(
                      ...
                      decoration: const InputDecoration(
                        ...
                        hintText:
                        "Search by Ward, Subcounty, or County",
                    ...
                    Expanded(
                      child: StreamBuilder<QuerySnapshot>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          if (reports.isEmpty) {
                            return const Center(
                              child: Text("No fire reports available"),
                            );
                          }
